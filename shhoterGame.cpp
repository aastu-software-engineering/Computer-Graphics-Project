...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"Addis Ababa Science And Technology Unversity");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-300, 385, 0.0,"Department of Software Engineering");;
		glColor3f(0.0, 0.0, 1.0);
	displayRasterText(-170, 300, 0.0,"Group Project For ");
		glColor3f(1.0, 0.0, 1.0);
	displayRasterText(-170, 225, 0.0,"Computer Graphics");
   		glColor3f(1.0, 0.7, 0.8);
	displayRasterText(-100, 150, 0.0,"created by");
		glColor3f(1.0, 1.0, 1.0);
	 displayRasterText(-130, 80, 0.0," Group Members");
	 	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Ruth Wossen");
	displayRasterText(-800, -285, 0.0," Yohannes Getachew");
    	displayRasterText(-800, -370, 0.0," Yidnekachew Tebeje");
        	displayRasterText(-800, -460, 0.0," Saron Meseret");
            	displayRasterText(-800, -550, 0.0," Samuel Amsalu");

		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Submitted To");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Mr Fasil");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-250, -400, 0.0,"Thursday-January-26-2024");
        glColor3f(1.0, 1.0, 1.0);
